...
data class UserProfile(
    ...
    val tier: String = "Q4 PRO • Founder Track",
    val sprintGoalName: String = "Launch Full SaaS MVP & Acquire First 100 Paid Users",
    val sprintStartDate: String = "2026-10-10",
    ...
    val totalHoursLogged: Float = 128.5f,
