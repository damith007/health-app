...
data class RealtimeAnalytics(
    val currentSprintDay: Int = 1,
    val totalSprintDays: Int = 90,
    val focusLoggedHours: Float = 0f,
    val targetFocusHours: Float = 0f,
    val executionRatePct: Float = 0f,
    val executionRateDelta: String = "0.0%",
    val focusEfficiencyPct: Int = 0,
    val unplannedHours: Float = 0f,
    val unplannedIncidents: Int = 0,
    val daysAheadOfSchedule: Int = 0,
    val projectedCompletionDay: Int = 90,
    val forecastFinishDate: String = "--",
    val chronotypeName: String = "Day Owl",
    val peakFocusWindow: String = "09:00 - 12:30",
    val peakFocusPercent: Int = 0,
    val topTimeLeakTitle: String = "Zero Leaks",
    val contextSwitchesPerDay: Float = 0f,
    val sprintTargetHours: Float = 720.0f,
